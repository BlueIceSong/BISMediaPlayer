 ...
 * On 2016/05/01 22:59
 */
public class VideoPlayerStandardFresco extends VideoPlayer {
    ...
    protected static UserActionStandard JC_USER_EVENT_STANDARD;

    public VideoPlayerStandardFresco(Context context) {
        super(context);
    }

    public VideoPlayerStandardFresco(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
