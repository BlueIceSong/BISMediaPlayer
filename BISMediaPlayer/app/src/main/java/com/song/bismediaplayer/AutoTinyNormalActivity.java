...
public class AutoTinyNormalActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        VideoPlayerStandard videoPlayerStandard = (VideoPlayerStandard) headerLayout.findViewById(R.id.jc_video);
        videoPlayerStandard.setUp("http://2449.vod.myqcloud.com/2449_22ca37a6ea9011e5acaaf51d105342e3.f20.mp4"
                , VideoPlayerStandard.SCREEN_LAYOUT_NORMAL, "example");
        Picasso.with(this)
