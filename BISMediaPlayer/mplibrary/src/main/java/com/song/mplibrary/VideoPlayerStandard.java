...
public class VideoPlayerStandard extends VideoPlayer {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (VideoPlayerManager.getCurrentJcvdOnFirtFloor() != null) {
                if (VideoPlayerManager.getCurrentJcvdOnFirtFloor().getUrl() != MediaManager.CURRENT_PLAYING_URL) {
                    releaseAllVideos();
                    return;
                }
            }
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            ...
            localLayoutParams.y = getResources().getDimensionPixelOffset(com.song.mplibrary.R.dimen.jc_progress_dialog_margin_top);
