 ...
 * On 2015/11/30 15:39
 */
public class MediaManager implements ExoPlayer.EventListener, SimpleExoPlayer.VideoListener, TextureView.SurfaceTextureListener {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        simpleExoPlayer.addListener(MediaManager.this);
                        simpleExoPlayer.setVideoListener(MediaManager.this);
    ...
    private MediaSource buildMediaSource(Context context, Uri uri) {
        int type = Utils.getUrlType(uri.toString());
        switch (type) {
            case C.TYPE_SS:
    ...
    public void onPlayerError(ExoPlaybackException error) {
        mainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                if (VideoPlayerManager.getCurrentJcvd() != null) {
                    VideoPlayerManager.getCurrentJcvd().onError(-10000, -10000);
                }
            }
        });
    }
